...
data class Landing_page_albumType(
    ...
    @SerializedName("sections") val sections: List<Landing_page_albumSection>
)
...
data class Album(
    ...
    @SerializedName("number_of_dislikes")  val numberOfDislikes: Int,      // 90
    @SerializedName("number_of_pictures")  val numberOfPictures: Int,      // 39
    @SerializedName("number_of_animated_pictures")    val numberOfAnimatedPictures: Int, // 0
    @SerializedName("number_of_duplicates")           val numberOfDuplicates: Int,       // 0
    @SerializedName("slug")         val slug: String,              // "nimbletail-art-comic-strips"
    @SerializedName("is_manga")     val isManga: Boolean,          // true
    ...
    @SerializedName("genres")       val genres: List<Genre> // [ {"id": "27", "title": "BDSM", "acts_as_warning": false, "url": "/genres/bdsm_27/?type=album"} ],...
)
