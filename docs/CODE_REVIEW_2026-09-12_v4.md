...
> **Срез:** `eebb12a` · **Статус:** открыт · **Индекс:** [все документы](README.md)
...
| --- | --- | --- | --- |
| C22 | корректность | открыт | — |
| S4 | безопасность / path traversal | открыт | — |
| T12 | конкурентность / app-lock | открыт | — |
| T13 | конкурентность / lifecycle | открыт | — |
| C23 | корректность / атомарность | открыт | — |
| C24 | корректность / устойчивость | открыт | — |
| T14 | конкурентность / потокобезопасность | открыт | — |
| C25 | производительность / ресурсы | открыт | — |
| A9 | архитектура / гигиена | открыт | — |
